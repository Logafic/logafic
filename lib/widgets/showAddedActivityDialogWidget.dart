...
// Ekran görüntüsü github adresinden erişilebilir. ' https://github.com/Logafic/logafic/blob/main/SS/show_dialog_activty_jobs.png '

class ShowAddedActivityDialogWidget extends StatefulWidget {
  ShowAddedActivityDialogWidget({Key? key}) : super(key: key);

  @override
  _ShowAddedActivityDialogWidgetState createState() =>
      _ShowAddedActivityDialogWidgetState();
}

class _ShowAddedActivityDialogWidgetState
    extends State<ShowAddedActivityDialogWidget> {
